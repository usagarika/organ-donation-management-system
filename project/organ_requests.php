...
<head>
    ...
    <style>
        ...
        /* For demonstration purpose, I'll keep it simple */
...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $con = new mysqli('localhost','root','','register');
            $stmt = $con->prepare("INSERT INTO organ_requests(`REGISTRATION_ID`, `ORGAN_TYPE`, `QUANTITY`, `BLOOD_GROUP`, `REQUEST_TYPE`, `ADDRESS`, `ZIPCODE`, `Phone`) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)");

            $stmt->bind_param("isisssis",$id,$ORGAN_TYPE,$QUANTITY,$BLOOD_GROUP,$REQUEST_TYPE,$ADDRESS,$ZIPCODE,$Phone);
            $stmt->execute();
            $stmt->close();
            $con->close();
    ?>
        ...
        <div class="wrapper">
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    ...
                    <div class="custom_select">
                        <select name="BLOOD_GROUP" id="blood-select" required>
                            <option value="">Select</option>
                ...
                <div class="inputfield">
                    ...
                    <input type="text" class="input" id="phoneN" name="Phone" required>
                </div> 
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <?php
                    $query = "SELECT * FROM organ_requests WHERE REGISTRATION_ID = '$id'";
