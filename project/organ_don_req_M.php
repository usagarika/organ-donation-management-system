...
<div style="font-family: 'Poppins', sans-serif; font-weight:400">
    ...
    <img alt="image" class="img-fluid small-image" style="padding: 25px 0px 25px;" src="images/male don3.webp">
</div>
                    </div>
                </div>
            </div>
                        ...
                        if($testostrone == 'yes'){
                            ?>
                                    <div class="alert alert-danger" role="alert">
                                        You can't donate Organ if you have low testostrone level.
                                    </div>
                            <?php
                        }
                        else if($cancer == 'yes'){
                            ?>
                                    <div class="alert alert-danger" role="alert">
                                        You can't donate Organ if you have cancer.
                                    </div>
                            <?php
                        }
                     ...
                     <input type="hidden" name="BLOOD_GROUP" value="<?php echo $req ?>">
                       <div class="mb-4 ">
                        ...
                        <div class="mb-4" required>
                            <label for="exampleInputEmail1" class="form-label">Are you Suffering with low testostrone?</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="testostrone" id="exampleRadios1" value="yes" >
                                <label class="form-check-label" for="exampleRadios1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="testostrone" id="exampleRadios2" value="no">
                        ...
                        <div class="mb-4" required>
                            <label for="exampleInputEmail1" class="form-label">Are you having cancer?</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="cancer" id="exampleRadios1" value="yes">
                                <label class="form-check-label" for="exampleRadios1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="cancer" id="exampleRadios2" value="no">
                                <label class="form-check-label" for="exampleRadios2">
                                    No
                                </label>
                            </div>
